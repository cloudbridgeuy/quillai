...
static welcome: Dir<'_> = include_dir!("./crates/blog/src/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("./crates/blog/src/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("./crates/blog/src/mailers/auth/magic_link");
